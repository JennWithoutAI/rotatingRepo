this repo is a work in progress for a site that changes based on the progress i am doing and the items i closed with the Obsidian API [https://obsidian.md/](Obsidian.md)

For now its just rotating colors but... its a work in progress since again 4 am
